...
?>
    <div class="alert alert-success my-4" role="alert">
        <h6>Election has been added successfully.</h6>
    </div>
<?php
...
?>
    <div class="alert alert-danger my-4" role="alert">
        <i>Election has been deleted successfully.</i>
    </div>
<?php
} else if (isset($_GET['updated'])) {
?>
    <div class="alert alert-success my-4" role="alert">
        <h6>Election has been updated successfully.</h6>
    </div>
<?php
}
?>
...
<div class="row">
    <div class="col-4 mt-4">
        ...
        <form method="post">
            ...
            <div class="form_group">
                <input type="number" name="number_of_candinates" placeholder="No of Candinates" class="form-control" required>
            </div><br>
            <div class="form_group">
...
<script>
    const EditData = (e_id) => {
        location.assign("edit_election.php?id=" + e_id);
    }
